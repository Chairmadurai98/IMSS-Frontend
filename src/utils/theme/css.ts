...
export const paper = ({ theme, bgcolor, dropdown }: ThemeConfig): SxProps => ({
    ...bgBlur({
        blur: 20,
        opacity: 0.9,
...
export const menuItem = (theme: Theme): SxProps => ({
...
export function bgBlur(props: Blur): SxProps {
...
export function bgGradient(props: BgGradient): SxProps {
...
export function textGradient(value: string): SxProps {
    return {
